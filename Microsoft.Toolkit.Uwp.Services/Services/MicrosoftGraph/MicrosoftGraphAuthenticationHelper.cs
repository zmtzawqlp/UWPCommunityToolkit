...
namespace Microsoft.Toolkit.Uwp.Services.MicrosoftGraph
{
    ...
    internal class MicrosoftGraphAuthenticationHelper
    {
        ...
        internal async Task<string> GetUserTokenAsync(string appClientId)
        {
            ...
            {
                AuthenticationResult userAuthnResult = await _azureAdContext.AcquireTokenAsync(MicrosoftGraphResource, appClientId, new Uri("http://localhost:8000"), new PlatformParameters(PromptBehavior.Always, false));
